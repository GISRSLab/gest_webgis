import {
  ...
  require_set,
  require_toPath
} from "./chunk-2NWWGSEC.js";
import "./chunk-BI4BIN56.js";
import {
  __toESM
} from "./chunk-CEQRFMJQ.js";

// node_modules/cytoscape/dist/cytoscape.esm.js
var import_debounce = __toESM(require_debounce());
var import_heap = __toESM(require_heap());
...
var memoize = function memoize2(fn3, keyFn) {
  ...
  var memoizedFn = function memoizedFn2() {
    ...
    if (!(ret = cache3[k])) {
      ret = cache3[k] = fn3.apply(self, args);
    }
    return ret;
  };
  memoizedFn.cache = {};
...
var elesfn$u = {
  dijkstra: function dijkstra(options2) {
    ...
    var Q = new import_heap.default(function(a, b) {
...
var elesfn$s = {
  ...
  aStar: function aStar(options2) {
    ...
    var fScore = {};
    var closedSetIds = {};
    var openSet = new import_heap.default(function(a, b) {
...
var hopcroftTarjanBiconnected = function hopcroftTarjanBiconnected2() {
  ...
  var biconnectedSearch = function biconnectedSearch2(root, currentNode, parent4) {
    if (root === parent4)
      edgeCount += 1;
    nodes3[currentNode] = {
      id: id2,
...
var define$2 = {
  ...
  data: function data(params) {
    var defaults3 = {
      ...
      updateStyle: false,
      beforeGet: function beforeGet2(self) {
      },
      beforeSet: function beforeSet3(self, obj) {
      },
      onSet: function onSet3(self) {
      },
      canSet: function canSet2(self) {
        return true;
      }
    };
    ...
    return function dataImpl(name, value) {
      ...
      if (string(name)) {
        ...
        var path = isPathLike && (0, import_toPath.default)(name);
        if (p2.allowGetting && value === void 0) {
          var ret;
          if (single) {
            p2.beforeGet(single);
            if (path && single._private[p2.field][name] === void 0) {
              ret = (0, import_get.default)(single._private[p2.field], path);
            } else {
          ...
          if (valid2) {
            ...
            for (var i = 0, l = all.length; i < l; i++) {
              ...
              if (p2.canSet(ele)) {
                if (path && single._private[p2.field][name] === void 0) {
                  (0, import_set.default)(ele._private[p2.field], path, value);
                } else {
...
var elesfn$h = {
  ...
  flashClass: function flashClass(classes2, duration) {
    ...
    self.addClass(classes2);
    setTimeout(function() {
      self.removeClass(classes2);
    }, duration);
    return self;
  }
};
...
var filter = function filter2(collection4) {
  ...
  if (self.length === 1 && self[0].checks.length === 1 && self[0].checks[0].type === Type.ID) {
    return collection4.getElementById(self[0].checks[0].value).collection();
  }
...
p.on = p.addListener = function(events, qualifier, callback, conf, confOverrides) {
  forEachEvent(this, function(self, event3, type, namespace, qualifier2, callback2, conf2) {
    if (fn$6(callback2)) {
      self.listeners.push({
        event: event3,
        // full event string
...
p.removeListener = p.off = function(events, qualifier, callback, conf) {
  ...
  var _loop = function _loop2(i2) {
    ...
    forEachEvent(_this, function(self, event3, type, namespace, qualifier2, callback2) {
  ...
  if (ani_p.delay == null) {
    ...
    if (props && props.length > 0 && isEles) {
      for (var i = 0; i < props.length; i++) {
        ...
        style3.overrideBypass(self, _name, easedVal);
      }
      self.emit("style");
    }
  }
...
styfn$8.getPropertiesDiff = function(oldCxtKey, newCxtKey) {
  var self = this;
  var cache3 = self._private.propDiffs = self._private.propDiffs || {};
...
styfn$1.parseImpl = function(name, value, propIsBypass, propIsFlat) {
  ...
  if (type.multiple && propIsFlat !== "multiple") {
    ...
    for (var i = 0; i < vals.length; i++) {
      var p2 = self.parse(name, vals[i], propIsBypass, "multiple");
...
BRp$3.load = function() {
  ...
  var onResize = (0, import_debounce.default)(function() {
    r.cy.resize();
  }, 100);
  if (haveMutationsApi) {
...
var defs = {
  setupDequeueing: function setupDequeueing(opts) {
    return function setupDequeueingImpl() {
      ...
      var queueRedraw = (0, import_debounce.default)(function() {
        r.redrawHint("eles", true);
        r.redrawHint("drag", true);
        r.redraw();
      ...
      var dequeue = function dequeue2(willDraw, frameStartTime) {
        ...
        while (true) {
          ...
          var thisDeqd = opts.deq(self, pixelRatio, extent2);
        ...
        if (deqd.length > 0) {
          ...
          if (!willDraw && opts.shouldRedraw(self, deqd, pixelRatio, extent2)) {
            queueRedraw();
          }
        }
      };
      var priority3 = opts.priority || noop$1;
      r.beforeRender(dequeue, priority3(self));
    };
  }
};
...
ETCp.getElementQueue = function() {
  var self = this;
  var q = self.eleCacheQueue = self.eleCacheQueue || new import_heap.default(function(a, b) {
...
ETCp.setupDequeueing = defs.setupDequeueing({
  ...
  deq: function deq(self, pxRatio, extent2) {
    return self.dequeue(pxRatio, extent2);
  },
  onDeqd: function onDeqd(self, deqd) {
    for (var i = 0; i < self.onDequeues.length; i++) {
      var fn3 = self.onDequeues[i];
      fn3(deqd);
    }
  },
  shouldRedraw: function shouldRedraw(self, deqd, pxRatio, extent2) {
...
var LayeredTextureCache = function LayeredTextureCache2(renderer3) {
  ...
  self.scheduleElementRefinement = (0, import_debounce.default)(function() {
  ...
  self.layersQueue = new import_heap.default(qSort);
  self.setupDequeueing();
};
...
LTCp.requestRedraw = (0, import_debounce.default)(function() {
  var r = this.renderer;
  r.redrawHint("eles", true);
  r.redrawHint("drag", true);
  r.redraw();
...
LTCp.setupDequeueing = defs.setupDequeueing({
  ...
  deqNoDrawCost,
  deqFastCost,
  deq: function deq2(self, pxRatio) {
    return self.dequeue(pxRatio);
  },
  onDeqd: noop$1,
  shouldRedraw: trueify,
  priority: function priority2(self) {
...
CRp$5.drawNode = function(context, node, shiftToOriginWithBb) {
  ...
  var getPath = function getPath2(width2, height2, shape, points) {
    ...
    var key = hashStrings(shape === "polygon" ? shape + "," + points.join(",") : shape, "" + height2, "" + width2);
...
*/
//# sourceMappingURL=cytoscape_dist_cytoscape__umd__js.js.map
